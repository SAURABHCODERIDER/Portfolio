...
const Footer = () => (
  <footer className=" border-t  shadow shadow-gray-200 font-serif font-mono text-gray-400">
    <div className="container mx-auto px-6 py-6 text-gray-500 flex flex-col md:flex-row items-center justify-between">
      ...
      <a href="https://www.naukri.com/mnjuser/homepage" target="_blank" rel="noopener noreferrer" className="rounded-full">
        <img
